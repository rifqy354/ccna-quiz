...
export default function NavBar() {
  ...
  if (!user) return null;
  return (
    <nav style={{ padding: '0.75rem 1.5rem', borderBottom: '1px solid #e5e7eb', display: 'flex', alignItems: 'center', gap: '1rem', flexWrap: 'wrap', background: 'white', position: 'sticky', top: 0, zIndex: 10 }}>
